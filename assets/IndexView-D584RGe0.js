...
`;class H extends ye{constructor(){super(...arguments),this.lastSize=[0,0],this.seed=Math.floor(Math.random()*2**31)}updated(e){this.wiredRender()}wiredRender(e=!1){if(this.svg){const t=this.canvasSize();if(!e&&t[0]===this.lastSize[0]&&t[1]===this.lastSize[1])return;for(;this.svg.hasChildNodes();)this.svg.removeChild(this.svg.lastChild);this.svg.setAttribute("width",`${t[0]}`),this.svg.setAttribute("height",`${t[1]}`),this.draw(this.svg,t),this.lastSize=t,this.classList.add("wired-rendered")}}fire(e,t){Mi(this,e,t)}}Qr([F("svg"),Jr("design:type",SVGSVGElement)],H.prototype,"svg",void 0);function ea(){return Math.floor(Math.random()*2**31)}function Mi(i,e,t){i.dispatchEvent(new CustomEvent(e,{composed:!0,bubbles:!0,detail:t}))}function gi(i,e,t){if(i&&i.length){const[n,s]=e,r=Math.PI/180*t,a=Math.cos(r),o=Math.sin(r);for(const l of i){const[c,d]=l;l[0]=(c-n)*a-(d-s)*o+n,l[1]=(c-n)*o+(d-s)*a+s}}}function ta(i,e,t){const n=[];i.forEach(s=>n.push(...s)),gi(n,e,t)}function ia(i,e){return i[0]===e[0]&&i[1]===e[1]}function na(i,e,t,n=1){const s=t,r=Math.max(e,.1),a=i[0]&&i[0][0]&&typeof i[0][0]=="number"?[i]:i,o=[0,0];if(s)for(const c of a)gi(c,o,s);const l=sa(a,r,n);if(s){for(const c of a)gi(c,o,-s);ta(l,o,-s)}return l}function sa(i,e,t){const n=[];for(const c of i){const d=[...c];ia(d[0],d[d.length-1])||d.push([d[0][0],d[0][1]]),d.length>2&&n.push(d)}const s=[];e=Math.max(e,.1);const r=[];for(const c of n)for(let d=0;d<c.length-1;d++){const u=c[d],p=c[d+1];if(u[1]!==p[1]){const h=Math.min(u[1],p[1]);r.push({ymin:h,ymax:Math.max(u[1],p[1]),x:h===u[1]?u[0]:p[0],islope:(p[0]-u[0])/(p[1]-u[1])})}}if(r.sort((c,d)=>c.ymin<d.ymin?-1:c.ymin>d.ymin?1:c.x<d.x?-1:c.x>d.x?1:c.ymax===d.ymax?0:(c.ymax-d.ymax)/Math.abs(c.ymax-d.ymax)),!r.length)return s;let a=[],o=r[0].ymin,l=0;for(;a.length||r.length;){if(r.length){let c=-1;for(let u=0;u<r.length&&!(r[u].ymin>o);u++)c=u;r.splice(0,c+1).forEach(u=>{a.push({s:o,edge:u})})}if(a=a.filter(c=>!(c.edge.ymax<=o)),a.sort((c,d)=>c.edge.x===d.edge.x?0:(c.edge.x-d.edge.x)/Math.abs(c.edge.x-d.edge.x)),(t!==1||l%e===0)&&a.length>1)for(let c=0;c<a.length;c=c+2){const d=c+1;if(d>=a.length)break;const u=a[c].edge,p=a[d].edge;s.push([[Math.round(u.x),o],[Math.round(p.x),o]])}o+=t,a.forEach(c=>{c.edge.x=c.edge.x+t*c.edge.islope}),l++}return s}function kn(i,e){var t;const n=e.hachureAngle+90;let s=e.hachureGap;s<0&&(s=e.strokeWidth*4),s=Math.round(Math.max(s,.1));let r=1;return e.roughness>=1&&(((t=e.randomizer)===null||t===void 0?void 0:t.next())||Math.random())>.7&&(r=s),na(i,s,n,r||1)}class ra{constructor(e){this.helper=e}fillPolygons(e,t){return this._fillPolygons(e,t)}_fillPolygons(e,t){const n=kn(e,t);return{type:"fillSketch",ops:this.renderLines(n,t)}}renderLines(e,t){const n=[];for(const s of e)n.push(...this.helper.doubleLineOps(s[0][0],s[0][1],s[1][0],s[1][1],t));return n}}function aa(i){const e=i[0],t=i[1];return Math.sqrt(Math.pow(e[0]-t[0],2)+Math.pow(e[1]-t[1],2))}class oa extends ra{fillPolygons(e,t){let n=t.hachureGap;n<0&&(n=t.strokeWidth*4),n=Math.max(n,.1);const s=Object.assign({},t,{hachureGap:n}),r=kn(e,s),a=Math.PI/180*t.hachureAngle,o=[],l=n*.5*Math.cos(a),c=n*.5*Math.sin(a);for(const[u,p]of r)aa([u,p])&&o.push([[u[0]-l,u[1]+c],[...p]],[[u[0]+l,u[1]-c],[...p]]);return{type:"fillSketch",ops:this.renderLines(o,t)}}}class la{constructor(e){this.seed=e}next(){return this.seed?(2**31-1&(this.seed=Math.imul(48271,this.seed)))/2**31:Math.random()}}function zn(i,e,t,n,s){return{type:"path",ops:$t(i,e,t,n,s)}}function da(i,e,t){const n=(i||[]).length;if(n>2){const s=[];for(let r=0;r<n-1;r++)s.push(...$t(i[r][0],i[r][1],i[r+1][0],i[r+1][1],t));return s.push(...$t(i[n-1][0],i[n-1][1],i[0][0],i[0][1],t)),{type:"path",ops:s}}else if(n===2)return zn(i[0][0],i[0][1],i[1][0],i[1][1],t);return{type:"path",ops:[]}}function Bn(i,e){return da(i,!0,e)}function ca(i,e,t,n,s){const r=[[i,e],[i+t,e],[i+t,e+n],[i,e+n]];return Bn(r,s)}function jn(i,e,t,n,s){const r=Dn(t,n,s);return ua(i,e,s,r).opset}function Dn(i,e,t){const n=Math.sqrt(Math.PI*2*Math.sqrt((Math.pow(i/2,2)+Math.pow(e/2,2))/2)),s=Math.ceil(Math.max(t.curveStepCount,t.curveStepCount/Math.sqrt(200)*n)),r=Math.PI*2/s;let a=Math.abs(i/2),o=Math.abs(e/2);const l=1-t.curveFitting;return a+=V(a*l,t),o+=V(o*l,t),{increment:r,rx:a,ry:o}}function ua(i,e,t,n){const[s,r]=fn(n.increment,i,e,n.rx,n.ry,1,n.increment*vi(.1,vi(.4,1,t),t),t);let a=un(s,null,t);if(!t.disableMultiStroke&&t.roughness!==0){const[o]=fn(n.increment,i,e,n.rx,n.ry,1.5,0,t),l=un(o,null,t);a=a.concat(l)}return{estimatedPoints:r,opset:{type:"path",ops:a}}}function fa(i,e,t,n,s){return $t(i,e,t,n,s,!0)}function Nn(i){return i.randomizer||(i.randomizer=new la(i.seed||0)),i.randomizer.next()}function vi(i,e,t,n=1){return t.roughness*n*(Nn(t)*(e-i)+i)}function V(i,e,t=1){return vi(-i,i,e,t)}function $t(i,e,t,n,s,r=!1){const a=r?s.disableMultiStrokeFill:s.disableMultiStroke,o=yi(i,e,t,n,s,!0,!1);if(a)return o;const l=yi(i,e,t,n,s,!0,!0);return o.concat(l)}function yi(i,e,t,n,s,r,a){const o=Math.pow(i-t,2)+Math.pow(e-n,2),l=Math.sqrt(o);let c=1;l<200?c=1:l>500?c=.4:c=-.0016668*l+1.233334;let d=s.maxRandomnessOffset||0;d*d*100>o&&(d=l/10);const u=d/2,p=.2+Nn(s)*.2;let h=s.bowing*s.maxRandomnessOffset*(n-e)/200,v=s.bowing*s.maxRandomnessOffset*(i-t)/200;h=V(h,s,c),v=V(v,s,c);const x=[],E=()=>V(u,s,c),f=()=>V(d,s,c),g=s.preserveVertices;return a?x.push({op:"move",data:[i+(g?0:E()),e+(g?0:E())]}):x.push({op:"move",data:[i+(g?0:V(d,s,c)),e+(g?0:V(d,s,c))]}),a?x.push({op:"bcurveTo",data:[h+i+(t-i)*p+E(),v+e+(n-e)*p+E(),h+i+2*(t-i)*p+E(),v+e+2*(n-e)*p+E(),t+(g?0:E()),n+(g?0:E())]}):x.push({op:"bcurveTo",data:[h+i+(t-i)*p+f(),v+e+(n-e)*p+f(),h+i+2*(t-i)*p+f(),v+e+2*(n-e)*p+f(),t+(g?0:f()),n+(g?0:f())]}),x}function un(i,e,t){const n=i.length,s=[];if(n>3){const r=[],a=1-t.curveTightness;s.push({op:"move",data:[i[1][0],i[1][1]]});for(let o=1;o+2<n;o++){const l=i[o];r[0]=[l[0],l[1]],r[1]=[l[0]+(a*i[o+1][0]-a*i[o-1][0])/6,l[1]+(a*i[o+1][1]-a*i[o-1][1])/6],r[2]=[i[o+1][0]+(a*i[o][0]-a*i[o+2][0])/6,i[o+1][1]+(a*i[o][1]-a*i[o+2][1])/6],r[3]=[i[o+1][0],i[o+1][1]],s.push({op:"bcurveTo",data:[r[1][0],r[1][1],r[2][0],r[2][1],r[3][0],r[3][1]]})}}else n===3?(s.push({op:"move",data:[i[1][0],i[1][1]]}),s.push({op:"bcurveTo",data:[i[1][0],i[1][1],i[2][0],i[2][1],i[2][0],i[2][1]]})):n===2&&s.push(...yi(i[0][0],i[0][1],i[1][0],i[1][1],t,!0,!0));return s}function fn(i,e,t,n,s,r,a,o){const l=o.roughness===0,c=[],d=[];if(l){i=i/4,d.push([e+n*Math.cos(-i),t+s*Math.sin(-i)]);for(let u=0;u<=Math.PI*2;u=u+i){const p=[e+n*Math.cos(u),t+s*Math.sin(u)];c.push(p),d.push(p)}d.push([e+n*Math.cos(0),t+s*Math.sin(0)]),d.push([e+n*Math.cos(i),t+s*Math.sin(i)])}else{const u=V(.5,o)-Math.PI/2;d.push([V(r,o)+e+.9*n*Math.cos(u-i),V(r,o)+t+.9*s*Math.sin(u-i)]);const p=Math.PI*2+u-.01;for(let h=u;h<p;h=h+i){const v=[V(r,o)+e+n*Math.cos(h),V(r,o)+t+s*Math.sin(h)];c.push(v),d.push(v)}d.push([V(r,o)+e+n*Math.cos(u+Math.PI*2+a*.5),V(r,o)+t+s*Math.sin(u+Math.PI*2+a*.5)]),d.push([V(r,o)+e+.98*n*Math.cos(u+a),V(r,o)+t+.98*s*Math.sin(u+a)]),d.push([V(r,o)+e+.9*n*Math.cos(u+a*.5),V(r,o)+t+.9*s*Math.sin(u+a*.5)])}return[d,c]}const pa={randOffset(i,e){return i},randOffsetWithRange(i,e,t){return(i+e)/2},ellipse(i,e,t,n,s){return jn(i,e,t,n,s)},doubleLineOps(i,e,t,n,s){return fa(i,e,t,n,s)}};function Fe(i){return{maxRandomnessOffset:2,roughness:1,bowing:.85,stroke:"#000",strokeWidth:1.5,curveTightness:0,curveFitting:.95,curveStepCount:9,fillStyle:"hachure",fillWeight:3.5,hachureAngle:-41,hachureGap:5,dashOffset:-1,dashGap:-1,zigzagOffset:0,combineNestedSvgPaths:!1,disableMultiStroke:!1,disableMultiStrokeFill:!1,seed:i}}function ha(i,e){let t="";for(const n of i.ops){const s=n.data;switch(n.op){case"move":if(e&&t)break;t+=`M${s[0]} ${s[1]} `;break;case"bcurveTo":t+=`C${s[0]} ${s[1]}, ${s[2]} ${s[3]}, ${s[4]} ${s[5]} `;break;case"lineTo":t+=`L${s[0]} ${s[1]} `;break}}return t.trim()}function Ge(i,e){const t=document.createElementNS("http://www.w3.org/2000/svg",i);if(e)for(const n in e)t.setAttributeNS(null,n,e[n]);return t}function lt(i,e,t=!1){const n=Ge("path",{d:ha(i,t)});return e&&e.appendChild(n),n}function Q(i,e,t,n,s,r){return lt(ca(e+2,t+2,n-4,s-4,Fe(r)),i)}function D(i,e,t,n,s,r){return lt(zn(e,t,n,s,Fe(r)),i)}function ma(i,e,t){return lt(Bn(e,Fe(t)),i,!0)}function Pe(i,e,t,n,s,r){return n=Math.max(n>10?n-4:n-1,1),s=Math.max(s>10?s-4:s-1,1),lt(jn(e,t,n,s,Fe(r)),i)}function kt(i,e){const n=new oa(pa).fillPolygon(i,Fe(e));return lt(n,null)}function Oi(i,e,t,n,s){const r=Fe(s),a=Dn(t,n,r),o=[];let l=0;for(;l<=Math.PI*2;)o.push([i+a.rx*Math.cos(l),e+a.ry*Math.sin(l)]),l+=a.increment;return kt(o,s)}var zt=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},Bt=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let tt=class extends H{constructor(){super(),this.elevation=1,this.disabled=!1,this.roAttached=!1,window.ResizeObserver&&(this.ro=new window.ResizeObserver(()=>{this.svg&&this.wiredRender(!0)}))}static get styles(){return[N,k`
        :host {
    ...
    `}focus(){this.button?this.button.focus():super.focus()}canvasSize(){if(this.button){const e=this.button.getBoundingClientRect(),t=Math.min(Math.max(1,this.elevation),5),n=e.width+(t-1)*2,s=e.height+(t-1)*2;return[n,s]}return this.lastSize}draw(e,t){const n=Math.min(Math.max(1,this.elevation),5),s={width:t[0]-(n-1)*2,height:t[1]-(n-1)*2};Q(e,0,0,s.width,s.height,this.seed);for(let r=1;r<n;r++)D(e,r*2,s.height+r*2,s.width+r*2,s.height+r*2,this.seed).style.opacity=`${(75-r*10)/100}`,D(e,s.width+r*2,s.height+r*2,s.width+r*2,r*2,this.seed).style.opacity=`${(75-r*10)/100}`,D(e,r*2,s.height+r*2,s.width+r*2,s.height+r*2,this.seed).style.opacity=`${(75-r*10)/100}`,D(e,s.width+r*2,s.height+r*2,s.width+r*2,r*2,this.seed).style.opacity=`${(75-r*10)/100}`}updated(){super.updated(),this.roAttached||this.attachResizeListener()}disconnectedCallback(){this.detachResizeListener()}attachResizeListener(){this.button&&this.ro&&(this.ro.observe(this.button),this.roAttached=!0)}detachResizeListener(){this.button&&this.ro&&this.ro.unobserve(this.button),this.roAttached=!1}};zt([S({type:Number}),Bt("design:type",Object)],tt.prototype,"elevation",void 0);zt([S({type:Boolean,reflect:!0}),Bt("design:type",Object)],tt.prototype,"disabled",void 0);zt([F("button"),Bt("design:type",HTMLButtonElement)],tt.prototype,"button",void 0);tt=zt([z("wired-button"),Bt("design:paramtypes",[])],tt);var Pi=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},Ri=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let it=class extends H{constructor(){super(),this.elevation=1,this.roAttached=!1,window.ResizeObserver&&(this.resizeObserver=new window.ResizeObserver(()=>{this.svg&&this.wiredRender()}))}static get styles(){return[N,k`
        :host {
          display: inline-block;
          position: relative;
          padding: 10px;
    ...
    `}updated(e){const t=e.has("fill");this.wiredRender(t),this.attachResizeListener()}disconnectedCallback(){this.detachResizeListener()}attachResizeListener(){this.roAttached||(this.resizeObserver?this.resizeObserver.observe(this):this.windowResizeHandler||(this.windowResizeHandler=()=>this.wiredRender(),window.addEventListener("resize",this.windowResizeHandler,{passive:!0})),this.roAttached=!0)}detachResizeListener(){this.resizeObserver&&this.resizeObserver.unobserve(this),this.windowResizeHandler&&window.removeEventListener("resize",this.windowResizeHandler),this.roAttached=!1}canvasSize(){const e=this.getBoundingClientRect(),t=Math.min(Math.max(1,this.elevation),5),n=e.width+(t-1)*2,s=e.height+(t-1)*2;return[n,s]}draw(e,t){const n=Math.min(Math.max(1,this.elevation),5),s={width:t[0]-(n-1)*2,height:t[1]-(n-1)*2};if(this.fill&&this.fill.trim()){const r=kt([[2,2],[s.width-4,2],[s.width-2,s.height-4],[2,s.height-4]],this.seed);r.classList.add("cardFill"),e.style.setProperty("--wired-card-background-fill",this.fill.trim()),e.appendChild(r)}Q(e,2,2,s.width-4,s.height-4,this.seed);for(let r=1;r<n;r++)D(e,r*2,s.height-4+r*2,s.width-4+r*2,s.height-4+r*2,this.seed).style.opacity=`${(85-r*10)/100}`,D(e,s.width-4+r*2,s.height-4+r*2,s.width-4+r*2,r*2,this.seed).style.opacity=`${(85-r*10)/100}`,D(e,r*2,s.height-4+r*2,s.width-4+r*2,s.height-4+r*2,this.seed).style.opacity=`${(85-r*10)/100}`,D(e,s.width-4+r*2,s.height-4+r*2,s.width-4+r*2,r*2,this.seed).style.opacity=`${(85-r*10)/100}`}};Pi([S({type:Number}),Ri("design:type",Object)],it.prototype,"elevation",void 0);Pi([S({type:String}),Ri("design:type",String)],it.prototype,"fill",void 0);it=Pi([z("wired-card"),Ri("design:paramtypes",[])],it);var dt=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},jt=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let Ve=class extends H{constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.focused=!1}static get styles(){return[N,k`
      :host {
        display: inline-block;
        font-family: inherit;
      }
    ...
    `}onChange(){this.checked=this.input.checked,this.refreshCheckVisibility(),this.fire("change",{checked:this.checked})}canvasSize(){return[24,24]}draw(e,t){Q(e,0,0,t[0],t[1],this.seed),this.svgCheck=Ge("g"),e.appendChild(this.svgCheck),D(this.svgCheck,t[0]*.3,t[1]*.4,t[0]*.5,t[1]*.7,this.seed),D(this.svgCheck,t[0]*.5,t[1]*.7,t[0]+5,-5,this.seed)}refreshCheckVisibility(){this.svgCheck&&(this.svgCheck.style.display=this.checked?"":"none")}};dt([S({type:Boolean}),jt("design:type",Object)],Ve.prototype,"checked",void 0);dt([S({type:Boolean,reflect:!0}),jt("design:type",Object)],Ve.prototype,"disabled",void 0);dt([Kr(),jt("design:type",Object)],Ve.prototype,"focused",void 0);dt([F("input"),jt("design:type",HTMLInputElement)],Ve.prototype,"input",void 0);Ve=dt([z("wired-checkbox")],Ve);var Dt=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},Ai=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let nt=class extends H{constructor(){super(...arguments),this.value="",this.name="",this.selected=!1}static get styles(){return[N,k`
      :host {
        display: inline-block;
        font-size: 14px;
        text-align: left;
    ...
    <button class="${this.selected?"selected":""}">
      <div id="overlay"><svg></svg></div>
      <span><slot></slot></span>
    </button>`}canvasSize(){const e=this.getBoundingClientRect();return[e.width,e.height]}draw(e,t){const n=kt([[0,0],[t[0],0],[t[0],t[1]],[0,t[1]]],this.seed);e.appendChild(n)}};Dt([S(),Ai("design:type",Object)],nt.prototype,"value",void 0);Dt([S(),Ai("design:type",Object)],nt.prototype,"name",void 0);Dt([S({type:Boolean}),Ai("design:type",Object)],nt.prototype,"selected",void 0);nt=Dt([z("wired-item")],nt);var qe=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},ct=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let Re=class extends ye{constructor(){super(...arguments),this.disabled=!1,this.seed=ea(),this.cardShowing=!1,this.itemNodes=[]}static get styles(){return k`
      :host {
        display: inline-block;
        font-family: inherit;
        position: relative;
    ...
    `}refreshDisabledState(){this.disabled?this.classList.add("wired-disabled"):this.classList.remove("wired-disabled"),this.tabIndex=this.disabled?-1:+(this.getAttribute("tabindex")||0)}firstUpdated(){this.setAttribute("role","combobox"),this.setAttribute("aria-haspopup","listbox"),this.refreshSelection(),this.addEventListener("blur",()=>{this.cardShowing&&this.setCardShowing(!1)}),this.addEventListener("keydown",e=>{switch(e.keyCode){case 37:case 38:e.preventDefault(),this.selectPrevious();break;case 39:case 40:e.preventDefault(),this.selectNext();break;case 27:e.preventDefault(),this.cardShowing&&this.setCardShowing(!1);break;case 13:e.preventDefault(),this.setCardShowing(!this.cardShowing);break;case 32:e.preventDefault(),this.cardShowing||this.setCardShowing(!0);break}})}updated(e){e.has("disabled")&&this.refreshDisabledState();const t=this.svg;for(;t.hasChildNodes();)t.removeChild(t.lastChild);const n=this.shadowRoot.getElementById("container").getBoundingClientRect();t.setAttribute("width",`${n.width}`),t.setAttribute("height",`${n.height}`);const s=this.shadowRoot.getElementById("textPanel").getBoundingClientRect();this.shadowRoot.getElementById("dropPanel").style.minHeight=s.height+"px",Q(t,0,0,s.width,s.height,this.seed);const r=s.width-4;Q(t,r,0,34,s.height,this.seed);const a=Math.max(0,Math.abs((s.height-24)/2)),o=ma(t,[[r+8,5+a],[r+26,5+a],[r+17,a+Math.min(s.height,18)]],this.seed);if(o.style.fill="currentColor",o.style.pointerEvents=this.disabled?"none":"auto",o.style.cursor="pointer",this.classList.add("wired-rendered"),this.setAttribute("aria-expanded",`${this.cardShowing}`),!this.itemNodes.length){this.itemNodes=[];const l=this.shadowRoot.getElementById("slot").assignedNodes();if(l&&l.length)for(let c=0;c<l.length;c++){const d=l[c];d.tagName==="WIRED-ITEM"&&(d.setAttribute("role","option"),this.itemNodes.push(d))}}}refreshSelection(){this.lastSelectedItem&&(this.lastSelectedItem.selected=!1,this.lastSelectedItem.removeAttribute("aria-selected"));const t=this.shadowRoot.getElementById("slot").assignedNodes();if(t){let n=null;for(let s=0;s<t.length;s++){const r=t[s];if(r.tagName==="WIRED-ITEM"){const a=r.value||r.getAttribute("value")||"";if(this.selected&&a===this.selected){n=r;break}}}this.lastSelectedItem=n||void 0,this.lastSelectedItem&&(this.lastSelectedItem.selected=!0,this.lastSelectedItem.setAttribute("aria-selected","true")),n?this.value={value:n.value||"",text:n.textContent||""}:this.value=void 0}}setCardShowing(e){this.card&&(this.cardShowing=e,this.card.style.display=e?"":"none",e&&setTimeout(()=>{this.shadowRoot.getElementById("slot").assignedNodes().filter(n=>n.nodeType===Node.ELEMENT_NODE).forEach(n=>{const s=n;s.requestUpdate&&s.requestUpdate()})},10),this.setAttribute("aria-expanded",`${this.cardShowing}`))}onItemClick(e){e.stopPropagation(),this.selected=e.target.value,this.refreshSelection(),this.fireSelected(),setTimeout(()=>{this.setCardShowing(!1)})}fireSelected(){Mi(this,"selected",{selected:this.selected})}selectPrevious(){const e=this.itemNodes;if(e.length){let t=-1;for(let n=0;n<e.length;n++)if(e[n]===this.lastSelectedItem){t=n;break}t<0?t=0:t===0?t=e.length-1:t--,this.selected=e[t].value||"",this.refreshSelection(),this.fireSelected()}}selectNext(){const e=this.itemNodes;if(e.length){let t=-1;for(let n=0;n<e.length;n++)if(e[n]===this.lastSelectedItem){t=n;break}t<0||t>=e.length-1?t=0:t++,this.selected=e[t].value||"",this.refreshSelection(),this.fireSelected()}}onCombo(e){e.stopPropagation(),this.setCardShowing(!this.cardShowing)}};qe([S({type:Object}),ct("design:type",Object)],Re.prototype,"value",void 0);qe([S({type:String,reflect:!0}),ct("design:type",String)],Re.prototype,"selected",void 0);qe([S({type:Boolean,reflect:!0}),ct("design:type",Object)],Re.prototype,"disabled",void 0);qe([F("svg"),ct("design:type",SVGSVGElement)],Re.prototype,"svg",void 0);qe([F("#card"),ct("design:type",HTMLDivElement)],Re.prototype,"card",void 0);Re=qe([z("wired-combo")],Re);var Nt=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},Ii=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let st=class extends ye{constructor(){super(...arguments),this.elevation=5,this.open=!1}static get styles(){return k`
      #container {
        position: fixed;
        top: 0;
        left: 0;
    ...
    `}updated(){this.card&&this.card.wiredRender(!0)}};Nt([S({type:Number}),Ii("design:type",Object)],st.prototype,"elevation",void 0);Nt([S({type:Boolean,reflect:!0}),Ii("design:type",Object)],st.prototype,"open",void 0);Nt([F("wired-card"),Ii("design:type",it)],st.prototype,"card",void 0);st=Nt([z("wired-dialog")],st);var Hn=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},ga=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let bi=class extends H{constructor(){super(...arguments),this.elevation=1,this.roAttached=!1}static get styles(){return[N,k`
        :host {
          display: block;
          position: relative;
        }
      `]}render(){return L`<svg></svg>`}canvasSize(){const e=this.getBoundingClientRect(),t=Math.min(Math.max(1,this.elevation),5);return[e.width,t*6]}draw(e,t){const n=Math.min(Math.max(1,this.elevation),5);for(let s=0;s<n;s++)D(e,0,s*6+3,t[0],s*6+3,this.seed)}updated(){super.updated(),this.attachResizeListener()}disconnectedCallback(){this.detachResizeListener()}attachResizeListener(){this.roAttached||(this.resizeObserver?this.resizeObserver.observe(this):this.windowResizeHandler||(this.windowResizeHandler=()=>this.wiredRender(),window.addEventListener("resize",this.windowResizeHandler,{passive:!0})),this.roAttached=!0)}detachResizeListener(){this.resizeObserver&&this.resizeObserver.unobserve(this),this.windowResizeHandler&&window.removeEventListener("resize",this.windowResizeHandler),this.roAttached=!1}};Hn([S({type:Number}),ga("design:type",Object)],bi.prototype,"elevation",void 0);bi=Hn([z("wired-divider")],bi);var Li=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},Gn=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let Ct=class extends H{constructor(){super(...arguments),this.disabled=!1}static get styles(){return[N,k`
        :host {
          display: inline-block;
          font-size: 14px;
          color: #fff;
    ...
    `}canvasSize(){if(this.button){const e=this.button.getBoundingClientRect();return[e.width,e.height]}return this.lastSize}draw(e,t){const n=Math.min(t[0],t[1]),s=Oi(n/2,n/2,n,n,this.seed);e.appendChild(s)}};Li([S({type:Boolean,reflect:!0}),Gn("design:type",Object)],Ct.prototype,"disabled",void 0);Li([F("button"),Gn("design:type",HTMLButtonElement)],Ct.prototype,"button",void 0);Ct=Li([z("wired-fab")],Ct);var ki=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},Vn=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let Mt=class extends H{constructor(){super(...arguments),this.disabled=!1}static get styles(){return[N,k`
        :host {
          display: inline-block;
          font-size: 14px;
        }
    ...
    `}canvasSize(){if(this.button){const e=this.button.getBoundingClientRect();return[e.width,e.height]}return this.lastSize}draw(e,t){const n=Math.min(t[0],t[1]);e.setAttribute("width",`${n}`),e.setAttribute("height",`${n}`),Pe(e,n/2,n/2,n,n,this.seed)}};ki([S({type:Boolean,reflect:!0}),Vn("design:type",Object)],Mt.prototype,"disabled",void 0);ki([F("button"),Vn("design:type",HTMLButtonElement)],Mt.prototype,"button",void 0);Mt=ki([z("wired-icon-button")],Mt);var zi=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},Bi=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};const va="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=";let Ot=class extends H{constructor(){super(),this.elevation=1,this.src=va,this.roAttached=!1,window.ResizeObserver&&(this.resizeObserver=new window.ResizeObserver(()=>{this.svg&&this.wiredRender()}))}static get styles(){return[N,k`
        :host {
          display: inline-block;
          position: relative;
          line-height: 1;
    ...
    <img src="${this.src}">
    <div id="overlay"><svg></svg></div>
    `}updated(){super.updated(),this.attachResizeListener()}disconnectedCallback(){this.detachResizeListener()}attachResizeListener(){this.roAttached||(this.resizeObserver&&this.resizeObserver.observe?this.resizeObserver.observe(this):this.windowResizeHandler||(this.windowResizeHandler=()=>this.wiredRender(),window.addEventListener("resize",this.windowResizeHandler,{passive:!0})),this.roAttached=!0)}detachResizeListener(){this.resizeObserver&&this.resizeObserver.unobserve&&this.resizeObserver.unobserve(this),this.windowResizeHandler&&window.removeEventListener("resize",this.windowResizeHandler),this.roAttached=!1}canvasSize(){const e=this.getBoundingClientRect(),t=Math.min(Math.max(1,this.elevation),5),n=e.width+(t-1)*2,s=e.height+(t-1)*2;return[n,s]}draw(e,t){const n=Math.min(Math.max(1,this.elevation),5),s={width:t[0]-(n-1)*2,height:t[1]-(n-1)*2};Q(e,2,2,s.width-4,s.height-4,this.seed);for(let r=1;r<n;r++)D(e,r*2,s.height-4+r*2,s.width-4+r*2,s.height-4+r*2,this.seed).style.opacity=`${(85-r*10)/100}`,D(e,s.width-4+r*2,s.height-4+r*2,s.width-4+r*2,r*2,this.seed).style.opacity=`${(85-r*10)/100}`,D(e,r*2,s.height-4+r*2,s.width-4+r*2,s.height-4+r*2,this.seed).style.opacity=`${(85-r*10)/100}`,D(e,s.width-4+r*2,s.height-4+r*2,s.width-4+r*2,r*2,this.seed).style.opacity=`${(85-r*10)/100}`}};zi([S({type:Number}),Bi("design:type",Object)],Ot.prototype,"elevation",void 0);zi([S({type:String}),Bi("design:type",String)],Ot.prototype,"src",void 0);Ot=zi([z("wired-image"),Bi("design:paramtypes",[])],Ot);var Y=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},X=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let W=class extends H{constructor(){super(),this.disabled=!1,this.placeholder="",this.type="text",this.autocomplete="",this.autocapitalize="",this.autocorrect="",this.required=!1,this.autofocus=!1,this.readonly=!1,this.roAttached=!1,window.ResizeObserver&&(this.resizeObserver=new window.ResizeObserver(()=>{this.svg&&this.wiredRender(!0)}))}static get styles(){return[N,k`
        :host {
          display: inline-block;
          position: relative;
          padding: 5px;
    ...
    `}get input(){return this.textInput}get value(){const e=this.input;return e&&e.value||""}set value(e){if(this.shadowRoot){const t=this.input;if(t){t.value=e;return}}this.pendingValue=e}firstUpdated(){this.value=this.pendingValue||this.value||this.getAttribute("value")||"",delete this.pendingValue}canvasSize(){const e=this.getBoundingClientRect();return[e.width,e.height]}draw(e,t){Q(e,2,2,t[0]-2,t[1]-2,this.seed)}refire(e){e.stopPropagation(),this.fire(e.type,{sourceEvent:e})}focus(){this.textInput?this.textInput.focus():super.focus()}updated(){super.updated(),this.attachResizeListener()}disconnectedCallback(){this.detachResizeListener()}attachResizeListener(){this.roAttached||(this.textInput&&this.resizeObserver&&this.resizeObserver.observe(this.textInput),this.roAttached=!0)}detachResizeListener(){this.textInput&&this.resizeObserver&&this.resizeObserver.unobserve(this.textInput),this.roAttached=!1}};Y([S({type:Boolean,reflect:!0}),X("design:type",Object)],W.prototype,"disabled",void 0);Y([S({type:String}),X("design:type",Object)],W.prototype,"placeholder",void 0);Y([S({type:String}),X("design:type",String)],W.prototype,"name",void 0);Y([S({type:String}),X("design:type",String)],W.prototype,"min",void 0);Y([S({type:String}),X("design:type",String)],W.prototype,"max",void 0);Y([S({type:String}),X("design:type",String)],W.prototype,"step",void 0);Y([S({type:String}),X("design:type",Object)],W.prototype,"type",void 0);Y([S({type:String}),X("design:type",Object)],W.prototype,"autocomplete",void 0);Y([S({type:String}),X("design:type",Object)],W.prototype,"autocapitalize",void 0);Y([S({type:String}),X("design:type",Object)],W.prototype,"autocorrect",void 0);Y([S({type:Boolean}),X("design:type",Object)],W.prototype,"required",void 0);Y([S({type:Boolean}),X("design:type",Object)],W.prototype,"autofocus",void 0);Y([S({type:Boolean}),X("design:type",Object)],W.prototype,"readonly",void 0);Y([S({type:Number}),X("design:type",Number)],W.prototype,"minlength",void 0);Y([S({type:Number}),X("design:type",Number)],W.prototype,"maxlength",void 0);Y([S({type:Number}),X("design:type",Number)],W.prototype,"size",void 0);Y([F("input"),X("design:type",HTMLInputElement)],W.prototype,"textInput",void 0);W=Y([z("wired-input"),X("design:paramtypes",[])],W);var ut=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},Ht=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let We=class extends H{constructor(){super(...arguments),this.elevation=1}static get styles(){return[N,k`
        :host {
          display: inline-block;
          position: relative;
        }
    ...
    `}focus(){this.anchor?this.anchor.focus():super.focus()}canvasSize(){if(this.anchor){const e=this.anchor.getBoundingClientRect(),t=Math.min(Math.max(1,this.elevation),5),n=e.width,s=e.height+(t-1)*2;return[n,s]}return this.lastSize}draw(e,t){const n=Math.min(Math.max(1,this.elevation),5),s={width:t[0],height:t[1]-(n-1)*2};for(let r=0;r<n;r++)D(e,0,s.height+r*2-2,s.width,s.height+r*2-2,this.seed),D(e,0,s.height+r*2-2,s.width,s.height+r*2-2,this.seed)}};ut([S({type:Number}),Ht("design:type",Object)],We.prototype,"elevation",void 0);ut([S({type:String}),Ht("design:type",String)],We.prototype,"href",void 0);ut([S({type:String}),Ht("design:type",String)],We.prototype,"target",void 0);ut([F("a"),Ht("design:type",HTMLAnchorElement)],We.prototype,"anchor",void 0);We=ut([z("wired-link")],We);var Gt=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},ji=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let rt=class extends H{constructor(){super(...arguments),this.horizontal=!1,this.itemNodes=[],this.itemClickHandler=this.onItemClick.bind(this)}static get styles(){return[N,k`
      :host {
        display: inline-block;
        font-family: inherit;
        position: relative;
    ...
    `}firstUpdated(){this.setAttribute("role","listbox"),this.tabIndex=+(this.getAttribute("tabindex")||0),this.refreshSelection(),this.addEventListener("click",this.itemClickHandler),this.addEventListener("keydown",e=>{switch(e.keyCode){case 37:case 38:e.preventDefault(),this.selectPrevious();break;case 39:case 40:e.preventDefault(),this.selectNext();break}})}updated(){if(super.updated(),this.horizontal?this.classList.add("wired-horizontal"):this.classList.remove("wired-horizontal"),!this.itemNodes.length){this.itemNodes=[];const e=this.shadowRoot.getElementById("slot").assignedNodes();if(e&&e.length)for(let t=0;t<e.length;t++){const n=e[t];n.tagName==="WIRED-ITEM"&&(n.setAttribute("role","option"),this.itemNodes.push(n))}}}onItemClick(e){e.stopPropagation(),this.selected=e.target.value,this.refreshSelection(),this.fireSelected()}refreshSelection(){this.lastSelectedItem&&(this.lastSelectedItem.selected=!1,this.lastSelectedItem.removeAttribute("aria-selected"));const t=this.shadowRoot.getElementById("slot").assignedNodes();if(t){let n=null;for(let s=0;s<t.length;s++){const r=t[s];if(r.tagName==="WIRED-ITEM"){const a=r.value||"";if(this.selected&&a===this.selected){n=r;break}}}this.lastSelectedItem=n||void 0,this.lastSelectedItem&&(this.lastSelectedItem.selected=!0,this.lastSelectedItem.setAttribute("aria-selected","true")),n?this.value={value:n.value||"",text:n.textContent||""}:this.value=void 0}}fireSelected(){this.fire("selected",{selected:this.selected})}selectPrevious(){const e=this.itemNodes;if(e.length){let t=-1;for(let n=0;n<e.length;n++)if(e[n]===this.lastSelectedItem){t=n;break}t<0?t=0:t===0?t=e.length-1:t--,this.selected=e[t].value||"",this.refreshSelection(),this.fireSelected()}}selectNext(){const e=this.itemNodes;if(e.length){let t=-1;for(let n=0;n<e.length;n++)if(e[n]===this.lastSelectedItem){t=n;break}t<0||t>=e.length-1?t=0:t++,this.selected=e[t].value||"",this.refreshSelection(),this.fireSelected()}}canvasSize(){const e=this.getBoundingClientRect();return[e.width,e.height]}draw(e,t){Q(e,0,0,t[0],t[1],this.seed)}};Gt([S({type:Object}),ji("design:type",Object)],rt.prototype,"value",void 0);Gt([S({type:String}),ji("design:type",String)],rt.prototype,"selected",void 0);Gt([S({type:Boolean}),ji("design:type",Object)],rt.prototype,"horizontal",void 0);rt=Gt([z("wired-listbox")],rt);var ft=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},Vt=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let Ae=class extends H{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.percentage=!1}static get styles(){return[N,k`
      :host {
        display: inline-block;
        position: relative;
        width: 400px;
    ...
    `}getProgressLabel(){return this.percentage?this.max===this.min?"%":Math.floor((this.value-this.min)/(this.max-this.min)*100)+"%":""+this.value}wiredRender(e=!1){super.wiredRender(e),this.refreshProgressFill()}canvasSize(){const e=this.getBoundingClientRect();return[e.width,e.height]}draw(e,t){Q(e,2,2,t[0]-2,t[1]-2,this.seed)}refreshProgressFill(){if(this.progBox&&(this.progBox.parentElement&&this.progBox.parentElement.removeChild(this.progBox),this.progBox=void 0),this.svg){let e=0;const t=this.getBoundingClientRect();if(this.max>this.min){e=(this.value-this.min)/(this.max-this.min);const n=t.width*Math.max(0,Math.min(e,100));this.progBox=kt([[0,0],[n,0],[n,t.height],[0,t.height]],this.seed),this.svg.appendChild(this.progBox),this.progBox.classList.add("progbox")}}}};ft([S({type:Number}),Vt("design:type",Object)],Ae.prototype,"value",void 0);ft([S({type:Number}),Vt("design:type",Object)],Ae.prototype,"min",void 0);ft([S({type:Number}),Vt("design:type",Object)],Ae.prototype,"max",void 0);ft([S({type:Boolean}),Vt("design:type",Object)],Ae.prototype,"percentage",void 0);Ae=ft([z("wired-progress")],Ae);var Ue=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},pt=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let Ie=class extends H{constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.focused=!1}static get styles(){return[N,k`
      :host {
        display: inline-block;
        font-family: inherit;
      }
    ...
    `}onChange(){this.checked=this.input.checked,this.refreshCheckVisibility(),this.fire("change",{checked:this.checked})}canvasSize(){return[24,24]}draw(e,t){Pe(e,t[0]/2,t[1]/2,t[0],t[1],this.seed),this.svgCheck=Ge("g"),e.appendChild(this.svgCheck);const n=Math.max(t[0]*.6,5),s=Math.max(t[1]*.6,5);Pe(this.svgCheck,t[0]/2,t[1]/2,n,s,this.seed)}refreshCheckVisibility(){this.svgCheck&&(this.svgCheck.style.display=this.checked?"":"none")}};Ue([S({type:Boolean}),pt("design:type",Object)],Ie.prototype,"checked",void 0);Ue([S({type:Boolean,reflect:!0}),pt("design:type",Object)],Ie.prototype,"disabled",void 0);Ue([S({type:String}),pt("design:type",String)],Ie.prototype,"name",void 0);Ue([S(),pt("design:type",Object)],Ie.prototype,"focused",void 0);Ue([F("input"),pt("design:type",HTMLInputElement)],Ie.prototype,"input",void 0);Ie=Ue([z("wired-radio")],Ie);var Wn=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},ya=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let wi=class extends ye{constructor(){super(...arguments),this.radioNodes=[],this.checkListener=this.handleChecked.bind(this)}static get styles(){return k`
      :host {
        display: inline-block;
        font-family: inherit;
        outline: none;
    ...
    `}focus(){this.input?this.input.focus():super.focus()}onInput(e){e.stopPropagation(),this.updateThumbPosition(),this.input&&this.fire("change",{value:+this.input.value})}wiredRender(e=!1){super.wiredRender(e),this.updateThumbPosition()}canvasSize(){const e=this.getBoundingClientRect();return[e.width,e.height]}draw(e,t){this.canvasWidth=t[0];const n=Math.round(t[1]/2);D(e,0,n,t[0],n,this.seed).classList.add("bar"),this.knob=Pe(e,10,n,20,20,this.seed),this.knob.classList.add("knob")}updateThumbPosition(){if(this.input){const e=+this.input.value,t=Math.max(this.step,this.max-this.min),n=(e-this.min)/t;this.knob&&(this.knob.style.transform=`translateX(${n*(this.canvasWidth-20)}px)`)}}};Xe([S({type:Number}),ht("design:type",Object)],_e.prototype,"min",void 0);Xe([S({type:Number}),ht("design:type",Object)],_e.prototype,"max",void 0);Xe([S({type:Number}),ht("design:type",Object)],_e.prototype,"step",void 0);Xe([S({type:Boolean,reflect:!0}),ht("design:type",Object)],_e.prototype,"disabled",void 0);Xe([F("input"),ht("design:type",HTMLInputElement)],_e.prototype,"input",void 0);_e=Xe([z("wired-slider")],_e);var Di=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},Fn=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let Pt=class extends H{constructor(){super(...arguments),this.spinning=!1,this.duration=1500,this.value=0,this.timerstart=0,this.frame=0}static get styles(){return[N,k`
      ...
      `]}render(){return L`<svg></svg>`}canvasSize(){return[76,76]}draw(e,t){Pe(e,t[0]/2,t[1]/2,Math.floor(t[0]*.8),Math.floor(.8*t[1]),this.seed),this.knob=Oi(0,0,20,20,this.seed),this.knob.classList.add("knob"),e.appendChild(this.knob),this.updateCursor()}updateCursor(){if(this.knob){const e=[Math.round(38+25*Math.cos(this.value*Math.PI*2)),Math.round(38+25*Math.sin(this.value*Math.PI*2))];this.knob.style.transform=`translate3d(${e[0]}px, ${e[1]}px, 0) rotateZ(${Math.round(this.value*360*2)}deg)`}}updated(){super.updated(),this.spinning?this.startSpinner():this.stopSpinner()}startSpinner(){this.stopSpinner(),this.value=0,this.timerstart=0,this.nextTick()}stopSpinner(){this.frame&&(window.cancelAnimationFrame(this.frame),this.frame=0)}nextTick(){this.frame=window.requestAnimationFrame(e=>this.tick(e))}tick(e){this.spinning?(this.timerstart||(this.timerstart=e),this.value=Math.min(1,(e-this.timerstart)/this.duration),this.updateCursor(),this.value>=1&&(this.value=0,this.timerstart=0),this.nextTick()):this.frame=0}};Di([S({type:Boolean}),Fn("design:type",Object)],Pt.prototype,"spinning",void 0);Di([S({type:Number}),Fn("design:type",Object)],Pt.prototype,"duration",void 0);Pt=Di([z("wired-spinner")],Pt);var Ni=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},Hi=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let Rt=class extends H{constructor(){super(),this.name="",this.label="",window.ResizeObserver&&(this.resizeObserver=new window.ResizeObserver(()=>{this.svg&&this.wiredRender()}))}static get styles(){return[N,k`
        :host {
          display: inline-block;
          position: relative;
          padding: 10px;
    ...
    <div id="overlay"><svg></svg></div>
    `}updated(){super.updated(),this.attachResizeListener()}disconnectedCallback(){this.detachResizeListener()}attachResizeListener(){this.resizeObserver&&this.resizeObserver.observe?this.resizeObserver.observe(this):this.windowResizeHandler||(this.windowResizeHandler=()=>this.wiredRender(),window.addEventListener("resize",this.windowResizeHandler,{passive:!0}))}detachResizeListener(){this.resizeObserver&&this.resizeObserver.unobserve&&this.resizeObserver.unobserve(this),this.windowResizeHandler&&window.removeEventListener("resize",this.windowResizeHandler)}canvasSize(){const e=this.getBoundingClientRect();return[e.width,e.height]}draw(e,t){Q(e,2,2,t[0]-4,t[1]-4,this.seed)}};Ni([S({type:String}),Hi("design:type",Object)],Rt.prototype,"name",void 0);Ni([S({type:String}),Hi("design:type",Object)],Rt.prototype,"label",void 0);Rt=Ni([z("wired-tab"),Hi("design:paramtypes",[])],Rt);var Gi=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},qn=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let At=class extends ye{constructor(){super(...arguments),this.pages=[],this.pageMap=new Map}static get styles(){return[N,k`
        :host {
          display: block;
          opacity: 1;
        }
    ...
    `}get textarea(){return this.textareaInput}get value(){const e=this.textarea;return e&&e.value||""}set value(e){if(this.shadowRoot){const t=this.textarea;if(t){t.value=e;return}}this.pendingValue=e}firstUpdated(){this.value=this.pendingValue||this.value||this.getAttribute("value")||"",delete this.pendingValue}canvasSize(){const e=this.getBoundingClientRect();return[e.width,e.height]}draw(e,t){Q(e,4,4,t[0]-4,t[1]-4,this.seed)}refire(e){e.stopPropagation(),this.fire(e.type,{sourceEvent:e})}};ne([S({type:Boolean,reflect:!0}),le("design:type",Object)],J.prototype,"disabled",void 0);ne([S({type:Number}),le("design:type",Object)],J.prototype,"rows",void 0);ne([S({type:Number}),le("design:type",Object)],J.prototype,"maxrows",void 0);ne([S({type:String}),le("design:type",Object)],J.prototype,"autocomplete",void 0);ne([S({type:Boolean}),le("design:type",Object)],J.prototype,"autofocus",void 0);ne([S({type:String}),le("design:type",Object)],J.prototype,"inputmode",void 0);ne([S({type:String}),le("design:type",Object)],J.prototype,"placeholder",void 0);ne([S({type:Boolean}),le("design:type",Object)],J.prototype,"required",void 0);ne([S({type:Boolean}),le("design:type",Object)],J.prototype,"readonly",void 0);ne([S({type:Number}),le("design:type",Number)],J.prototype,"minlength",void 0);ne([S({type:Number}),le("design:type",Number)],J.prototype,"maxlength",void 0);ne([F("textarea"),le("design:type",HTMLTextAreaElement)],J.prototype,"textareaInput",void 0);J=ne([z("wired-textarea")],J);var Wt=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},Vi=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let at=class extends H{constructor(){super(...arguments),this.checked=!1,this.disabled=!1}static get styles(){return[N,k`
      :host {
        display: inline-block;
        cursor: pointer;
        position: relative;
    ...
    `}focus(){this.input?this.input.focus():super.focus()}wiredRender(e=!1){super.wiredRender(e),this.refreshKnob()}onChange(){this.checked=this.input.checked,this.refreshKnob(),this.fire("change",{checked:this.checked})}canvasSize(){return[80,34]}draw(e,t){Q(e,16,8,t[0]-32,18,this.seed).classList.add("toggle-bar"),this.knob=Ge("g"),this.knob.classList.add("knob"),e.appendChild(this.knob);const s=Oi(16,16,32,32,this.seed);s.classList.add("knobfill"),this.knob.appendChild(s),Pe(this.knob,16,16,32,32,this.seed)}refreshKnob(){if(this.knob){const e=this.knob.classList;this.checked?(e.remove("unchecked"),e.add("checked")):(e.remove("checked"),e.add("unchecked"))}}};Wt([S({type:Boolean}),Vi("design:type",Object)],at.prototype,"checked",void 0);Wt([S({type:Boolean,reflect:!0}),Vi("design:type",Object)],at.prototype,"disabled",void 0);Wt([F("input"),Vi("design:type",HTMLInputElement)],at.prototype,"input",void 0);at=Wt([z("wired-toggle")],at);var de=function(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var o=i.length-1;o>=0;o--)(a=i[o])&&(r=(s<3?a(r):s>3?a(e,t,r):a(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},ce=function(i,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(i,e)};let oe=class extends H{constructor(){super(),this.src="",this.autoplay=!1,this.loop=!1,this.muted=!1,this.playsinline=!1,this.playing=!1,this.timeDisplay="",window.ResizeObserver&&(this.resizeObserver=new window.ResizeObserver(()=>{this.svg&&this.wiredRender()}))}static get styles(){return[N,k`
        :host {
          display: inline-block;
          position: relative;
          line-height: 1;
    ...
    `}updated(){super.updated(),this.attachResizeListener()}disconnectedCallback(){this.detachResizeListener()}attachResizeListener(){this.resizeObserver&&this.resizeObserver.observe?this.resizeObserver.observe(this):this.windowResizeHandler||(this.windowResizeHandler=()=>this.wiredRender(),window.addEventListener("resize",this.windowResizeHandler,{passive:!0}))}detachResizeListener(){this.resizeObserver&&this.resizeObserver.unobserve&&this.resizeObserver.unobserve(this),this.windowResizeHandler&&window.removeEventListener("resize",this.windowResizeHandler)}wiredRender(){super.wiredRender(),this.progressBar&&this.progressBar.wiredRender(!0)}canvasSize(){const e=this.getBoundingClientRect();return[e.width,e.height]}draw(e,t){Q(e,2,2,t[0]-4,t[1]-4,this.seed)}updateTime(){this.video&&this.progressBar&&(this.progressBar.value=this.video.duration?Math.round(this.video.currentTime/this.video.duration*100):0,this.timeDisplay=`${this.getTimeDisplay(this.video.currentTime)} / ${this.getTimeDisplay(this.video.duration)}`)}getTimeDisplay(e){const t=Math.floor(e/60),n=Math.round(e-t*60);return`${t}:${n}`}togglePause(){this.video&&(this.playing?this.video.pause():this.video.play())}volumeChange(){this.video&&this.slider&&(this.video.volume=this.slider.value/100)}canPlay(){this.slider&&this.video&&(this.slider.value=this.video.volume*100)}};de([S({type:String}),ce("design:type",Object)],oe.prototype,"src",void 0);de([S({type:Boolean}),ce("design:type",Object)],oe.prototype,"autoplay",void 0);de([S({type:Boolean}),ce("design:type",Object)],oe.prototype,"loop",void 0);de([S({type:Boolean}),ce("design:type",Object)],oe.prototype,"muted",void 0);de([S({type:Boolean}),ce("design:type",Object)],oe.prototype,"playsinline",void 0);de([S(),ce("design:type",Object)],oe.prototype,"playing",void 0);de([S(),ce("design:type",Object)],oe.prototype,"timeDisplay",void 0);de([F("wired-progress"),ce("design:type",Ae)],oe.prototype,"progressBar",void 0);de([F("wired-slider"),ce("design:type",_e)],oe.prototype,"slider",void 0);de([F("video"),ce("design:type",HTMLVideoElement)],oe.prototype,"video",void 0);oe=de([z("wired-video"),ce("design:paramtypes",[])],oe);const ba={data(){return{swiperOptions:{breakpoints:{767:{slidesPerView:3.2,spaceBetween:0},1024:{slidesPerView:4.1,spaceBetween:0}}},adList:[{title:"卷民暑期體驗！！「 夏日體驗班」７月２８日（日）開招！",img:"https://beyondarchitecture.jp/wp/wp-content/uploads/2017/07/unchiku_01.jpg"},{title:"卷民暑期體驗！！「 夏日體驗班」７月２８日（日）開招！",img:"https://beyondarchitecture.jp/wp/wp-content/uploads/2018/06/magazine_thum11-1.jpg"},{title:"卷民暑期體驗！！「 夏日體驗班」７月２８日（日）開招！",img:"https://beyondarchitecture.jp/wp/wp-content/uploads/2020/02/magazine_thum.jpg"},{title:"卷民暑期體驗！！「 夏日體驗班」７月２８日（日）開招！",img:"https://beyondarchitecture.jp/wp/wp-content/uploads/2020/06/magazine_thum_covid-1.jpg"},{title:"卷民暑期體驗！！「 夏日體驗班」７月２８日（日）開招！",img:"https://beyondarchitecture.jp/wp/wp-content/uploads/2020/01/magazine_thum_shiten01.jpg"},{title:"卷民暑期體驗！！「 夏日體驗班」７月２８日（日）開招！",img:"https://beyondarchitecture.jp/wp/wp-content/uploads/2020/04/magazine_thum_mokei.jpg"},{title:"卷民暑期體驗！！「 夏日體驗班」７月２８日（日）開招！",img:"https://beyondarchitecture.jp/wp/wp-content/uploads/2018/06/magazine_thum11-1.jpg"},{title:"卷民暑期體驗！！「 夏日體驗班」７月２８日（日）開招！",img:"https://beyondarchitecture.jp/wp/wp-content/uploads/2019/08/magazine_thum_sento.jpg"}]}},components:{Swiper:Mn,SwiperSlide:ke},setup(){return{modules:[Er]}}},wa={class:"card bg-white border-0 ps-sm-4 py-2 adSet"},xa={class:"card border-0"},Sa={class:"card-body"},_a=["src"],Ta={class:"d-flex justify-content-between align-items-center pt-2"},Ea={class:"card-title text-start border-bottom w-100 pb-2 mb-0"};function $a(i,e,t,n,s,r){const a=yt("router-link"),o=yt("swiper-slide"),l=yt("swiper");return j(),G("section",wa,[e[1]||(e[1]=O("div",{class:"card border border-0"},[O("div",{class:"card-body pb-0"},[O("h6",{class:"text-black-50"},"- pick up")])],-1)),q(l,{slidesPerView:1.3,spaceBetween:0,freeMode:!0,modules:n.modules,breakpoints:s.swiperOptions.breakpoints,class:"mySwiper px-2 px-sm-5 ps-sm-0"},{default:me(()=>[(j(!0),G(ge,null,je(s.adList,(c,d)=>(j(),Wi(o,{key:d},{default:me(()=>[O("div",xa,[O("div",Sa,[q(a,{to:"#",class:"mouseOver text-decoration-none"},{default:me(()=>[(j(),Wi(Zn("wired-card"),{elevation:"3"},{default:me(()=>[O("img",{src:c.img,class:"card-img-top rounded",alt:"..."},null,8,_a)]),_:2},1024)),O("div",Ta,[O("h6",Ea,te(c.title),1),e[0]||(e[0]=O("i",{class:"bi bi-arrow-right-short h4"},null,-1))])]),_:2},1024)])])]),_:2},1024))),128))]),_:1},8,["modules","breakpoints"])])}const Ca=Si(ba,[["render",$a],["__scopeId","data-v-96fdc945"]]),Ma={data(){return{menuList:[{date:"2024.07.18",category:"news",title:"卷民暑期體驗！！「 夏日體驗班」７月２８日（日）開招！"},{date:"2024.07.17",category:"news",title:"卷民暑期體驗！！「 夏日體驗班」７月２８日（日）開招！"},{date:"2024.07.17",category:"news",title:"卷民暑期體驗！！「 夏日體驗班」７月２８日（日）開招！"},{date:"2024.07.17",category:"news",title:"卷民暑期體驗！！「 夏日體驗班」７月２８日（日）開招！"},{date:"2024.07.17",category:"news",title:"卷民暑期體驗！！「 夏日體驗班」７月２８日（日）開招！"},{date:"2024.07.17",category:"note",title:"筆記筆記好多筆記通通免費！！！"},{date:"2024.07.17",category:"note",title:"筆記筆記好多筆記通通免費～～歐拉歐拉"},{date:"2024.07.17",category:"note",title:"筆記筆記好多筆記通通免費～～木大木大"},{date:"2024.07.17",category:"note",title:"講義講義新講義來下載"},{date:"2024.07.17",category:"note",title:"講義講義新講義來下載！！！！！"}]}},methods:{}},Oa={class:"card rounded-0 py-5 bg-white border-0"},Pa={class:"container"},Ra={class:"row row-cols-1 row-cols-lg-2 g-sm-4"},Aa={class:"col"},Ia={class:"card border-0"},La={class:"card-body"},ka={class:"list-unstyled","data-visible":"all"},za={key:0,class:"border-bottom"},Ba={class:"text-nowrap mb-1"},ja={datetime:"2024-07-18"},Da={class:"mx-3 text-nowrap mb-1"},Na={class:""},Ha={class:"card-footer bg-body border-0 text-end"},Ga={class:"col"},Va={class:"card border-0"},Wa={class:"card-body"},Fa={class:"list-unstyled","data-visible":"all"},qa={key:0,class:"border-bottom"},Ua={class:"text-nowrap mb-1"},Ya={datetime:"2024-07-18"},Xa={class:"mx-3 text-nowrap mb-1"},Ka={class:""},Za={class:"card-footer bg-body border-0 text-end"};function Qa(i,e,t,n,s,r){const a=yt("router-link");return j(),G("section",Oa,[O("div",Pa,[O("div",Ra,[O("div",Aa,[O("div",Ia,[O("div",La,[e[1]||(e[1]=O("div",{class:"card-title h3 border-bottom mb-0 pb-3 fw-bold"},"News",-1)),O("ul",ka,[(j(!0),G(ge,null,je(s.menuList,(o,l)=>(j(),G(ge,{key:l},[o.category==="news"?(j(),G("li",za,[q(a,{to:"#",class:"d-flex align-items-center pt-3 flex-wrap flex-lg-nowrap text-decoration-none mouseOver"},{default:me(()=>[O("p",Ba,[O("time",ja,te(o.date),1)]),O("p",Da,te(o.category),1),O("h5",Na,te(o.title),1)]),_:2},1024)])):Fi("",!0)],64))),128))]),O("div",Ha,[q(a,{to:"#",class:"text-dark"},{default:me(()=>e[0]||(e[0]=[li("查看更多"),O("i",{class:"bi bi-arrow-right-circle ms-1"},null,-1)])),_:1})])])])]),O("div",Ga,[O("div",Va,[O("div",Wa,[e[3]||(e[3]=O("div",{class:"card-title h3 border-bottom mb-0 pb-3 fw-bold"},"Note",-1)),O("ul",Fa,[(j(!0),G(ge,null,je(s.menuList,(o,l)=>(j(),G(ge,{key:l},[o.category==="note"?(j(),G("li",qa,[q(a,{to:"#",class:"d-flex align-items-center pt-3 flex-wrap flex-lg-nowrap text-decoration-none mouseOver"},{default:me(()=>[O("p",Ua,[O("time",Ya,te(o.date),1)]),O("p",Xa,te(o.category),1),O("h5",Ka,te(o.title),1)]),_:2},1024)])):Fi("",!0)],64))),128))]),O("div",Za,[q(a,{to:"#",class:"text-dark"},{default:me(()=>e[2]||(e[2]=[li("查看更多"),O("i",{class:"bi bi-arrow-right-circle ms-1"},null,-1)])),_:1})])])])])])])])}const Ja=Si(Ma,[["render",Qa],["__scopeId","data-v-f1a63e6f"]]),eo="/assets/advantageBg-LFmfSeQZ.jpg",to={class:"card border-0 rounded-0 bg-white overflow-hidden pe-sm-5"},io={class:"mb-2"},no={class:"fs-1"},so={class:"mb-0 text-black-50"},ro={__name:"AdvantageModel",setup(i){const e=K([{title:"自由排課",commit:"彈性安排與教師的上課時間"},{title:"專屬課程",commit:"依照你的能力、需求進行備課"},{title:"免費試聽",commit:"獨家視聽，滿意再購買"},{title:"頂尖教師",commit:"世界各地頂尖教師任你選擇"}]);return(t,n)=>(j(),G("section",to,[O("div",{class:"text-white pt-5 ps-sm-5 advantageSit",style:be([{"'border-radius'":"'0 24px 0 0'"},{backgroundImage:`url(${re(eo)})`}])},[n[0]||(n[0]=It('<h4 class="mb-2" data-v-a10336c2>卷民wrrrry的四大優勢</h4><h2 class="mb-5 d-flex" data-v-a10336c2><i class="fas fa-exclamation me-3" style="animation-delay:calc(1s * 0.1);" data-aos="animate__rotateInDownLeft" data-v-a10336c2></i><span style="animation-delay:calc(1s * 0.2);" class="animate__animated animate__rotateInDownLeft" data-v-a10336c2>爲</span><span style="animation-delay:calc(1s * 0.3);" class="animate__animated animate__rotateInDownLeft" data-v-a10336c2>何</span><span style="animation-delay:calc(1s * 0.4);" class="animate__animated animate__rotateInDownLeft" data-v-a10336c2>選</span><span style="animation-delay:calc(1s * 0.5);" class="animate__animated animate__rotateInDownLeft" data-v-a10336c2>擇</span><span style="animation-delay:calc(1s * 0.6);" class="animate__animated animate__rotateInDownLeft" data-v-a10336c2>捲</span><span style="animation-delay:calc(1s * 0.7);" class="animate__animated animate__rotateInDownLeft" data-v-a10336c2>民</span><span style="animation-delay:calc(1s * 0.8);" class="animate__animated animate__rotateInDownLeft" data-v-a10336c2>W</span><span style="animation-delay:calc(1s * 0.9);" class="animate__animated animate__rotateInDownLeft" data-v-a10336c2>r</span><span style="animation-delay:calc(1s * 1);" class="animate__animated animate__rotateInDownLeft" data-v-a10336c2>rrrry</span></h2>',2)),O("div",null,[(j(!0),G(ge,null,je(e.value,(s,r)=>(j(),G("div",{key:r,class:"py-8 d-block text-dark text-decoration-none advantageBox"},[O("div",{class:_i(["px-5 py-4 shadow-lg col-12 col-sm-5 animate__animated animate__fadeInDown",`marginLeft-${r}`])},[O("h2",io,[li(" #"+te(r+1)+" ",1),O("span",no,te(s.title),1)]),O("h3",so,te(s.commit),1)],2)]))),128))])],4)]))}},ao=Si(ro,[["__scopeId","data-v-a10336c2"]]),oo={class:"card bg-white border-0 rounded-0 p-5"},lo={class:""},co={class:"row row-cols-1 row-cols-md-3 g-4"},uo={class:"animate__animated animate__fadeInDown"},fo={class:"card border-0 shadow"},po=["src"],ho={class:"card-body"},mo={class:"card-title fs-3"},go={class:"card-text"},vo={__name:"SubjectModal",setup(i){const e=K([{title:"國中物理/理化",commit:"結合生活情境的趣味教學、詳細的概念解說、課後觀念確認，讓你用均一自學理化變得好簡單！",img:"https://images.unsplash.com/photo-1607988795691-3d0147b43231?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",color:"linear-gradient(90deg, #ed3131, #ff744f)"},{title:"高中物理/理化",img:"https://images.unsplash.com/photo-1636466497217-26a8cbeaf0aa?q=80&w=3174&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",commit:"物體的運動. 牛頓三大運動定律. 生活中常見的力. 查看課程內容. 物質的組成與交互作用. 物質的組成. 原子的結構. 基本交互作用",color:"linear-gradient(90deg, #fc841a, #fab82a)",ptSet:"pt-lg-4"},{title:"GRE 物理/理化",commit:"GRE物理測試（GRE Physics Test）是由美國教育測驗服務社（ETS）主辦的標準化考試。這項考試的範圍主要是美國大學物理學系本科前三年的課程內容。",img:"https://images.unsplash.com/photo-1635070041078-e363dbe005cb?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",color:"linear-gradient(90deg, #4ccb43, #9fd628)",ptSet:"pt-lg-5"},{title:"DSE 物理/理化",commit:"DSE）物理科是一門結合理論與實踐的科目，涵蓋廣泛的知識範疇，並要求學生具備良好的理解力和應用能力。",img:"https://plus.unsplash.com/premium_photo-1667119473280-23ed9fb45573?q=80&w=2900&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",color:"linear-gradient(90deg, #59c6c0, #88ddf5)"},{title:"IB 物理/理化",commit:"IB物理並不是一堂容易的課程，但假如學生對這門課有興趣，甚至大學想讀領域相關的主修，那你就應該要知道IB Physics SL和HL有什麼差別，以及應該如何選擇 ...",img:"https://images.unsplash.com/photo-1675458134252-1968ac5ef177?q=80&w=2808&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",color:"linear-gradient(90deg, #7749a7, #b48ad4)",ptSet:"pt-lg-4"},{title:"GCSE 物理/理化",commit:"GCSE 物理（General Certificate of Secondary Education - Physics）是英國中學教育體系中的一門核心科目，適用於 14 至 16 歲的學生。此課程涵蓋物理學的基本概念，並培養學生的科學思維、實驗技能和問題解決能力。",img:"https://images.unsplash.com/photo-1632571401005-458e9d244591?q=80&w=2942&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",color:"linear-gradient(90deg, #7747, #333)",ptSet:"pt-lg-5"}]);return(t,n)=>(j(),G("section",oo,[n[0]||(n[0]=It('<h2 class="mb-sm-5 mb-3 d-flex text-dark"><span style="animation-delay:calc(1s * 0.1);" class="animate__animated animate__rotateInDownLeft"><i class="fas fa-exclamation me-3"></i></span><span style="animation-delay:calc(1s * 0.2);" class="animate__animated animate__rotateInDownLeft">6</span><span style="animation-delay:calc(1s * 0.3);" class="animate__animated animate__rotateInDownLeft">大</span><span style="animation-delay:calc(1s * 0.4);" class="animate__animated animate__rotateInDownLeft">課</span><span style="animation-delay:calc(1s * 0.5);" class="animate__animated animate__rotateInDownLeft">程</span><span style="animation-delay:calc(1s * 0.6);" class="animate__animated animate__rotateInDownLeft">介</span><span style="animation-delay:calc(1s * 0.7);" class="animate__animated animate__rotateInDownLeft">紹</span></h2>',1)),O("div",lo,[O("div",co,[(j(!0),G(ge,null,je(e.value,(s,r)=>(j(),G("div",{key:r,class:_i(["",s.ptSet])},[O("div",uo,[O("div",fo,[O("div",{style:be([{height:"4px"},{background:s.color}])},null,4),O("img",{src:s.img,class:"card-img-top rounded-0",alt:"..."},null,8,po),O("div",ho,[O("div",mo,te(s.title),1),O("p",go,te(s.commit),1)])])])],2))),128))])])]))}},yo={class:"card bg-white p-5 border-0 rounded-0 grid_line"},bo={class:"container py-5"},wo={class:"message-board"},xo={__name:"FeedbackModel",setup(i){const e=K([{id:1,text:"LULU:老師講的比課本還生動，感覺像在聽故事一樣！",x:0,y:0,color:"bg-primary"},{id:2,text:"老師，這堂課的知識量超標了，我的腦袋快要升級了！",x:0,y:0,color:"bg-success"},{id:3,text:"這個留言板有點亂 XD",x:0,y:0,color:"bg-warning"},{id:4,text:"這堂課讓我腦袋開竅了！感覺像打開了新世界的大門！",x:0,y:0,color:"bg-info"},{id:5,text:"教室的貓助教會盯人上課 ：）",x:0,y:0,color:"bg-dark"},{id:6,text:"今天的課程就像一場精彩的電影，高潮迭起、知識點滿滿！",x:0,y:0,color:"bg-secondary"},{id:7,text:"我考上第一志願拉～～～",x:0,y:0,color:"bg-primary"},{id:8,text:"教室有滿滿的點心吃到飽～",x:0,y:0,color:"bg-success"},{id:9,text:"我發現這個概念超有趣，沒想到還能這樣應用！",x:0,y:0,color:"bg-warning"},{id:4,text:"很喜歡補習班的學習環境，大家一起衝刺！",x:0,y:0,color:"bg-info"},{id:5,text:"以前覺得這些知識很枯燥，但老師的講解讓我產生了興趣！",x:0,y:0,color:"bg-dark"},{id:10,text:"這堂課讓我對這個主題更有信心了！以前覺得難，現在覺得可以挑戰！",x:0,y:0,color:"bg-danger"}]),t=()=>({x:Math.random()*window.innerWidth*.5,y:Math.random()*window.innerHeight*.5});return xi(()=>{e.value.forEach(n=>{const s=t();n.x=s.x,n.y=s.y})}),(n,s)=>(j(),G("section",yo,[s[0]||(s[0]=It('<h2 class="d-flex text-dark"><span style="animation-delay:calc(1s * 0.1);" class="animate__animated animate__rotateInDownLeft"><i class="fas fa-exclamation me-3"></i></span><span style="animation-delay:calc(1s * 0.2);" class="animate__animated animate__rotateInDownLeft">學</span><span style="animation-delay:calc(1s * 0.3);" class="animate__animated animate__rotateInDownLeft">生</span><span style="animation-delay:calc(1s * 0.4);" class="animate__animated animate__rotateInDownLeft">回</span><span style="animation-delay:calc(1s * 0.5);" class="animate__animated animate__rotateInDownLeft">饋</span></h2>',1)),O("div",bo,[O("div",wo,[(j(!0),G(ge,null,je(e.value,r=>(j(),G("div",{key:r.id,class:_i(["message text-white p-3 rounded shadow",r.color]),style:be({top:r.y+"px",left:r.x+"px"})},te(r.text),7))),128))])])]))}},Xo={__name:"IndexView",setup(i){return(e,t)=>(j(),G(ge,null,[q(Ir),q(Ca,{class:"ms-sm-5",id:"breakpoint"}),q(Ja),q(ao),q(vo),q(xo)],64))}};export{Xo as default};
